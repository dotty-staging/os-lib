...
object os extends Module {
  object jvm extends Cross[OsJvmModule]((crossScalaVersions ++ TestUtil.dottyVersion):_*)
...
trait OsLibModule extends CrossScalaModule with PublishModule{
  ...
  def compileIvyDeps =
    if (crossScalaVersion.startsWith("2")) acyclicDep
...
trait OsModule extends OsLibModule{
  ...
  def ivyDeps =
    if (crossScalaVersion.startsWith("2"))
      Agg(ivy"com.lihaoyi::geny:0.6.2")
    else
      Agg(ivy"com.lihaoyi:geny_2.13:0.6.2")
}
